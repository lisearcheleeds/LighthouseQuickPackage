...
# Lighthouse QuickPackage
You can start game development simply by cloning this project.

---

## Author

**Lise** — [GitHub](https://github.com/lisearcheleeds) / [X](https://x.com/archeleeeds)
